...
constructor(
    ...
    fun registeredAccountResources(
        accountId: Long,
    ...
    fun fetchAuthenticateResources(
        serviceResources: AppTypes.Service.Resources,
        key: String,
        approvalResourceType: AppTypes.Authenticate.ApprovalResources
    ): AuthenticateAccountResources? {
    ...
    fun existsResourceKeysWithApprovalResourceType(serviceResources: AppTypes.Service.Resources, key: String, approvalResourceType: AppTypes.Authenticate.ApprovalResources): Boolean {
        return authenticateAccountResourcesRepository.existsByServiceResourcesAndKeyAndApprovalResourceTypeAndDeleted(
            serviceResources = serviceResources, key = key, approvalResourceType = approvalResourceType, deleted = false
        )
    }

    fun existsApprovalResourceTypeWithUsers(serviceResources: AppTypes.Service.Resources, referenceUserId: Long, approvalResourceType: AppTypes.Authenticate.ApprovalResources): Boolean {
